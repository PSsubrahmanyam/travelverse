...
function getLiveStationBoard(stationCode) {
...
function getCoachComposition(trainType) {
...
module.exports = { POPULAR_STATIONS, POPULAR_TRAINS, findTrainsBetweenStations, getLiveTrainStatus, getLiveStationBoard, getCoachComposition };
